  ...
  const licenseDefinitions = [
    {
      ...
      licenseKey: 'MS-E5-YON-9921-8834-KKL9',
    ...
    },
    {
      ...
      licenseKey: 'SAP-S4H-YON-8849-0192-PROD',
      status: 'ACTIVE' as const,
      autoRenew: true,
    ...
    },
    {
      ...
      licenseKey: 'LEC-MOD-BSL-2024-9981-CAD',
      status: 'ACTIVE' as const,
      autoRenew: true,
    ...
    },
    {
      ...
      licenseKey: 'GBR-ACCU-2024-8849-MRK',
      status: 'ACTIVE' as const,
      autoRenew: true,
    ...
    },
    {
      ...
      expiryDate: new Date('2026-12-31'),
      licenseKey: 'COAT-FRP-BSL-8849-SCHED',
      status: 'ACTIVE' as const,
      autoRenew: true,
    ...
    },
    {
      ...
      licenseKey: 'ADB-CC-YON-8392-1102-ENT',
      status: 'ACTIVE' as const,
      autoRenew: true,
    ...
    },
    {
      ...
      licenseKey: 'CSCO-UMB-YON-9921-SEC',
      status: 'ACTIVE' as const,
      autoRenew: true,
