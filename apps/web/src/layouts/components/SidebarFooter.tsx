      ...
      <div style={{ width: 260, padding: '2px 0' }}>
        ...
        >
          <Flex justify="space-between" align="center">
            <Text style={{ fontSize: 11.5, color: token.colorTextSecondary }}>API Response:</Text>
          ...
          <Flex justify="space-between" align="center">
            <Text style={{ fontSize: 11.5, color: token.colorTextSecondary }}>PostgreSQL:</Text>
            <Text
              strong
              style={{
                fontSize: 11.5,
                color:
                  health?.database?.status === 'connected' ? token.colorSuccess : token.colorError,
              }}
            >
          ...
          <Flex justify="space-between" align="center">
            <Text style={{ fontSize: 11.5, color: token.colorTextSecondary }}>Uptime:</Text>
            <Text strong style={{ fontSize: 11.5, color: token.colorText }}>
              {health?.uptimeFormatted ?? (isLoading ? 'Checking...' : 'N/A')}
            </Text>
          </Flex>
          <Flex justify="space-between" align="center">
            <Text style={{ fontSize: 11.5, color: token.colorTextSecondary }}>Memory:</Text>
            <Text strong style={{ fontSize: 11.5, color: token.colorText }}>
