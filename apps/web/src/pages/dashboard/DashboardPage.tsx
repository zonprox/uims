...
import { LaptopOutlined, SafetyCertificateOutlined, CustomerServiceOutlined, TeamOutlined, PlusOutlined } from '@ant-design/icons';
...
export default function DashboardPage() {
  ...
  const data = [
    { key: '1', time: '2023-10-27 10:00', user: 'Admin User', action: 'Created', entity: 'Asset L-1024' },
    { key: '2', time: '2023-10-27 09:30', user: 'Admin User', action: 'Updated', entity: 'Ticket #402' },
  ];
        ...
        <Col xs={24} md={8}>
          <Card title="Quick Actions">
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <Button icon={<PlusOutlined />} block>New Asset</Button>
              <Button icon={<PlusOutlined />} block>Assign License</Button>
              <Button icon={<PlusOutlined />} block>Create User</Button>
              <Button icon={<PlusOutlined />} block type="primary">Open Ticket</Button>
            </div>
          </Card>
        </Col>
      </Row>
