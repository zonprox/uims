...
export function isValidIP(ip: string): boolean {
  const ipv4Re = /^(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/;
...
export function isValidCIDR(cidr: string): boolean {
  ...
  return isValidIP(ip) && !isNaN(mask) && mask >= 0 && mask <= 128;
}
